...
public class makescons extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_makescons);
        ...
        webHtmlCss.loadUrl("file:///android_asset/makeinindia/construction.html");
