...
public class siobjective extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_siobjective);
        ...
        webHtmlCss.loadUrl("file:///android_asset/skillindia123/skill2.html");
