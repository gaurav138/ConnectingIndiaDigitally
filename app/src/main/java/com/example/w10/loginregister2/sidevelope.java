...
public class sidevelope extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sidevelope);
        ...
        webHtmlCss.loadUrl("file:///android_asset/skillindia123/skill3.html");
