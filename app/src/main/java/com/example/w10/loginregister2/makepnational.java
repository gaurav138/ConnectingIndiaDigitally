...
public class makepnational extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_makepnational);
        ...
        webHtmlCss.loadUrl("file:///android_asset/makeinindia/national-manufacturing.html");
