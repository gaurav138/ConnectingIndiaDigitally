...
public class sbobjectives extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sbobjectives);
        ...
        webHtmlCss.loadUrl("file:///android_asset/swchhbharat/swach3.html");
