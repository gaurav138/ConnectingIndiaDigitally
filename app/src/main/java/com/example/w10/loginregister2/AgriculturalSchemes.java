...
public class AgriculturalSchemes extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_agricultural_schemes);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* String url = "https://www.google.com/";
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AgriculturalSchemes.this);
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String url = "https://www.agri-insurance.gov.in/Login.aspx";
