...
public class makepforeign extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_makepforeign);
        ...
        webHtmlCss.loadUrl("file:///android_asset/makeinindia/foreign-direct-investment.html");
