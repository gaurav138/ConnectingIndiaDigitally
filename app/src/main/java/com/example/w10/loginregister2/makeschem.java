...
public class makeschem extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_makeschem);
        ...
        webHtmlCss.loadUrl("file:///android_asset/makeinindia/chemicals.html");
