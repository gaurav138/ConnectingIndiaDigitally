...
public class makesspace extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_makesspace);
        ...
        webHtmlCss.loadUrl("file:///android_asset/makeinindia/space.html");
