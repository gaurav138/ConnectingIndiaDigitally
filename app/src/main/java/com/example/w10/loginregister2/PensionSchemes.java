...
public class PensionSchemes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView ttt6=(TextView) findViewById(R.id.tttitle6);
        ...
        TextView ddd6=(TextView) findViewById(R.id.dddescription6);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PensionSchemes.this);
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String url = "https://www.pmjdy.gov.in/JanSuraksha/Default.aspx";
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String url = "https://www.icicibank.com/html/en/index.html";
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String url = "https://www.licindia.in/Products/Withdrawn-Plans/VARISHTHA-PENSION-BIMA-YOJANA-(UIN-512G2911V01)";
