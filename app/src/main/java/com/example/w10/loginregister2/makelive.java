...
public class makelive extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_makelive);
        ...
        webHtmlCss.loadUrl("file:///android_asset/makeinindia/live_projects.html");
